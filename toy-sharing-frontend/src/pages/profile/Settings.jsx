          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 border border-gray-200 rounded-xl hover:border-pink-500 transition-colors">
                ...
                <a
                  href="/profile/edit"
                  className="bg-pink-100 text-pink-600 px-4 py-2 rounded-lg font-medium hover:bg-pink-200 transition-colors"
                >
                  Chỉnh sửa
                </a>
              </div>
              ...
              {[
                {
                  ...
                  desc: "Nhận thông báo qua email về hoạt động tài khoản",
                  checked: true,
                },
                {
                  title: "Thông báo đặt mượn",
                  desc: "Thông báo khi có người muốn mượn đồ chơi",
                  checked: true,
                },
                {
                  title: "Thông báo trả về",
                  desc: "Nhắc nhở về thời hạn trả đồ chơi",
                  checked: true,
                },
                {
                  title: "Thông báo khuyến mãi",
                  desc: "Nhận thông tin về các chương trình khuyến mãi",
                  checked: false,
                },
              ].map((setting, index) => (
                <div
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  desc: "Cho phép người dùng khác xem số điện thoại",
                  checked: false,
                },
                {
                  title: "Hiển thị email",
                  desc: "Cho phép liên hệ qua email",
                  checked: false,
                },
                {
                  title: "Theo dõi hoạt động",
                  desc: "Ghi nhận hoạt động để cải thiện dịch vụ",
                  checked: true,
                },
              ].map((setting, index) => (
                <div
          ...
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">
                  Hành động này không thể hoàn tác. Tất cả dữ liệu và đồ chơi
