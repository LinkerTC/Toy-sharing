...
export const categoryHelpers = {
  getCategoryInfo: (key) => {
    return TOY_CATEGORIES[key.toUpperCase()] || TOY_CATEGORIES.OTHER
  },
  ...
  getConditionInfo: (key) => {
    return TOY_CONDITIONS[key.toUpperCase()] || TOY_CONDITIONS.FAIR
  },

  getBookingStatusInfo: (key) => {
    return BOOKING_STATUS[key.toUpperCase()] || BOOKING_STATUS.REQUESTED
  }
}
